...
class MagneticEnvironment(object):
    ...
    @classmethod
    def initFromCSV(cls, brPath, bzPath, plotXYScale=1.0):
        # get br
        ...
        # get plot
        plotCubeX0 = brDistribution.index.values.ravel().max() * plotXYScale
        plotCubeY0 = brDistribution.index.values.ravel().max() * plotXYScale
